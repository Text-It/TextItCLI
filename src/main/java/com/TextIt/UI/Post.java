...
public class Post {
    ...
    private static void showPostPreview(String username, String content) {
        ...
        System.out.println(CommonMethods.BRIGHT_CYAN + "│" + CommonMethods.RESET + " "
                + CommonMethods.BRIGHT_WHITE + CommonMethods.BOLD + header
                + CommonMethods.RESET
                + " ".repeat(WIDTH - header.length() - 1) // pad rest of line
        ...
        for (String contentLine : contentLines) {
            ...
            while (start < contentLine.length()) {
                ...
                System.out.println(CommonMethods.BRIGHT_CYAN + "│" + CommonMethods.RESET
                        + CommonMethods.BRIGHT_WHITE + displayLine
                        + " ".repeat(WIDTH - displayLine.length())
                        + CommonMethods.RESET
                        + CommonMethods.BRIGHT_CYAN + "│" + CommonMethods.RESET);
                start = end;
            }
