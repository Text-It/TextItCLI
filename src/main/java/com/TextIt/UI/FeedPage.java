...
public class FeedPage {
    ...
    public void onlyUserPosts(int userID){
            ...
            int pageSize = 1;   // show 1 post at a time
            int offset = 0;
            DoublyLinkedList<Integer> buffer = postdb.getPostIdsforParticularUser(pageSize, offset,userID);
            int bufferIndex = 0;
                ...
                switch (option) {
                    ...
                    case 8: // Next Post
                        if (bufferIndex < buffer.size() - 1) {
                            ...
                            offset += pageSize;
                            DoublyLinkedList<Integer> nextBatch = postdb.getPostIdsforParticularUser(pageSize, offset,userID);
                            if (!nextBatch.isEmpty()) {
                                buffer = nextBatch;
                                bufferIndex = 0;
                            } else {
