...
public class CareerMailHandler {
    ...
    public static void sendApplication(String applicantEmail, String applicantName,
                                       String role, File resumeFile) throws MessagingException, IOException {
        ...
        String hrBody = "<!DOCTYPE html>" +
                "<html>" +
                "<head>" +
                "<style>" +
                "  body { font-family: Arial, sans-serif; background-color: #f4f4f7; color: #333; margin: 0; padding: 0; }" +
                "  .container { background-color: #ffffff; max-width: 600px; margin: 20px auto; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1); }" +
                "  h2 { color: #4CAF50; }" +
                "  p { line-height: 1.6; }" +
                "  .info { background-color: #f9f9f9; padding: 10px; border-radius: 5px; margin-bottom: 15px; }" +
                "</style>" +
                "</head>" +
                "<body>" +
                "<div class='container'>" +
                ...
                "</div>" +
                "<p>Please find the resume attached for review.</p>" +
                "<p>Cheers,<br>TextIT Careers Team</p>" +
                "</div>" +
                "</body>" +
                "</html>";
        ...
        String applicantBody = "<!DOCTYPE html>" +
                "<html>" +
                "<head>" +
                "<style>" +
                "  body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #eef2f7; color: #333; margin: 0; padding: 0; }" +
                "  .container { background-color: #ffffff; max-width: 600px; margin: 20px auto; padding: 25px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); }" +
                "  h2 { color: #007BFF; }" +
                "  p { line-height: 1.6; }" +
                "  .highlight { background-color: #f1f8ff; padding: 8px; border-radius: 5px; display: inline-block; margin-bottom: 15px; }" +
                "</style>" +
                "</head>" +
                "<body>" +
                "<div class='container'>" +
                ...
                "<p>Thank you for applying for the role of <span class='highlight'>" + role + "</span> at TextIT.</p>" +
                "<p>Our HR team is reviewing your application and will contact you shortly regarding the next steps.</p>" +
                "<p>We appreciate your interest in joining our team! 🌟</p>" +
                "<p>Best regards,<br>TextIT Careers Team</p>" +
                "</div>" +
                "</body>" +
                "</html>";
